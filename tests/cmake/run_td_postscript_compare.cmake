...
function(run_render input_file render_name output_file stdout_var stderr_var)
  set(render_dir "${WORK_DIR}/${render_name}")
  file(MAKE_DIRECTORY "${render_dir}")

  set(work_input "${render_dir}/input.top")
  ...
  if(NOT EXISTS "${output_path}")
    file(GLOB work_dir_entries LIST_DIRECTORIES true "${render_dir}/*")
...
run_render("${LEFT_INPUT}" "left" "left.ps" left_stdout left_stderr)
run_render("${RIGHT_INPUT}" "right" "right.ps" right_stdout right_stderr)
